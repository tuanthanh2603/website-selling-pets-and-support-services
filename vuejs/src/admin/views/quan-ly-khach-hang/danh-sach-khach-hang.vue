    ...
    <div class="col-md-10">
      <div class="container-fluid mt-3">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h6 class="h3 mb-0 text-gray-800" style="font-size: 24px">
                    ...
                    <a-tab-pane key="1">
                      ...
                      >
                        ...
                        <a-form-item
                          ...
                          name="name"
                          :rules="[
                            { required: true, message: 'Không để trống tên!' },
                          ]"
                        >
...
export default defineComponent({
  ...
  setup() {
    ...
    const updateInfoClient = (values) => {
      ...
      const serverUrl =
        "http://localhost:3000/admin/quan-ly-khach-hang/updateInfoClient";
      axios
        .put(serverUrl, values)
        .then((response) => {
          new Noty({
