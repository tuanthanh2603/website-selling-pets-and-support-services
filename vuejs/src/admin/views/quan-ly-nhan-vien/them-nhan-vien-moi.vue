    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a-form :model="formAddUser" v-bind="layout" name="nest-messages"
                            :validate-messages="validateMessages" @finish="onFinish">
                            <a-form-item name="name" label="Tên nhân viên" :rules="[{ required: true }]">
                            ...
                            <a-form-item name="phone" label="Số điện thoại" :rules="[{ required: true }]">
                            ...
                            <a-form-item name="sex'" label="Giới tính" :rules="[{ required: true }]">
